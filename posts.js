...
function PostsDAO(db) {
    ...
    this.incrementLikes = function(permalink, comment_ordinal, callback) {
        ...
        var comm = 'comments.'+ comment_ordinal;
        var selector_example  = {};
        var comment_ordinal_example = 0;
        selector_example['comments.' + 0 + '.num_likes'] = 1;
        ...
        // is zero indexed).
        console.log("comm_num",comm);

        /*post_find_selector['comments.'+ comment_ordinal] = 1;
        posts.find({'permalink': permalink},post_find_selector,function(doc){
            console.dir(doc);
        });*/
        posts.update({'permalink': permalink},{$inc:selector_example}, function(err, post) {
            "use strict";
